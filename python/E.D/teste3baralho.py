...
class Jogar:
    ...
    def comecar(self):
        ...
        empates = 0
        while escolha == 'y':
            if len(self.baralho.cartas) < 2:
                print("Cartas insuficientes, reiniciando o baralho...")
            ...
            escolha = input("Quer jogar outra rodada? y-sim n-nao: ").lower()
            if escolha == 'n':
